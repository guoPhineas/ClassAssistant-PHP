...
<html><head>
    ...
    <body>
        ...
        <h2><?php echo $gradeName;?><br/>第<?php echo $weekNum;?>周周末请假单</h2>
...
<input type="checkbox" name="isSave"  style value="true" id="isSaveCheckbox" checked="checked"><span style='font-size:25px;'>将固定信息保存到本设备浏览器上</span>
</label>
<br/>
...
<script>
	...
	*/
	...
	/*
	setCookie("nameAndID",$('#sel1 option:selected').val(), 120);
	setCookie("myPhone",document.getElementById('phm').value, 120);
	setCookie("dormID",document.getElementById('dorm').value, 120);
	setCookie("parentName",document.getElementById('emep').value, 120);
	setCookie("parentPhone",document.getElementById('ePhone').value, 120);
	*/
        // 阻止表单默认提交行为
        //e.preventDefault();
